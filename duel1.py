...
class DQNAgent:
    def __init__(self, state_size, action_size,
        ...
        self.pa_tau = pa_tau
        self.duel_flag = duel_flag  # This line was missing
...
if __name__ == "__main__":
    ...
    for e in range(max_episodes):
            ...
            if done:
                ...
                print('Episode: {}, time steps: {}, AvgScore: {:0.2f}, \
                    epsilon: {:0.2f}, replay size: {}, Step Count: {}'.format(e, t,
                                                                             ...
                                                                             len(deepQ.memory),
                                                                             stepCounter))
                with open('/home/research/cp_result.txt', 'a+') as file2:
        ...
        if t > max_steps:
            max_steps = t
            deepQ.model.save_weights('/home/research/cp_model_steps_{}.h5'.format(t))

        # save model weights
        if e % model_save_freq == 0:
            deepQ.model.save_weights('cp_model_{}.h5'.format(e))

            with open("/home/research/cp_exp_{}.txt".format(e), 'wb') as file:
